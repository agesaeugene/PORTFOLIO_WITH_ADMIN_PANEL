  ...
  return (
    <div className="w-full">
      ...
      items-center mt-4 md:mt-8 lg:mt-10">
        ...
        <Link to={user?.linkedInURL || "https://www.linkedin.com/in/eugene-agesa-80a559279?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"} target="_blank">
          <Linkedin className="text-sky-500 w-7 h-7" />
        </Link>
        <Link to={user?.twitterURL || "https://www.linkedin.com/in/eugene-agesa-80a559279?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"} target="_blank">
